...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DGA5_JhZ.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-md bg-primary px-2.5 py-1.5 text-xs text-primary-foreground shadow-border animate-in fade-in-0 zoom-in-95", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-DVc5HJ1C.css";
var APP_NAME = "Casefile";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Compile arrest reports. Search by name, store, date, or case."
			}
		],
		links: [
			{
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Newsreader:opsz,wght@6..72,400;6..72,500;6..72,600&family=Source+Sans+3:ital,wght@0,400;0,500;0,600;0,700&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter = () => import("./routes-iUFCgsVb.mjs");
...
//#endregion
export { uid as i, cn as n, initials as r, router_exports as t };
